...
export default {
  ...
  methods: {
    ...
    searchOnTable() {
      this.leitores = searchByName(this.leitores, this.search);
    },
    aguardandoChegar() {
         axios.get("http://localhost:5000/leitores/1").then((response) => {
      this.leitores = response.data;
    });
        this.nomeEstagio = "Aguardando Chegar na Zhaz";
    },
    aguardandoVistoria() {
         axios.get("http://localhost:5000/leitores/3").then((response) => {
      this.leitores = response.data;
    });
        this.nomeEstagio = "Aguardando Vistoria";
    },
    aguardandoAprovacao() {
         axios.get("http://localhost:5000/leitores/6").then((response) => {
      this.leitores = response.data;
    });
        this.nomeEstagio = "Aguardando Aprovação";
    },
    Aprovado() {
         axios.get("http://localhost:5000/leitores/8").then((response) => {
      this.leitores = response.data;
    });
        this.nomeEstagio = "Aprovado !!!";
    },
    emManutencao() {
         axios.get("http://localhost:5000/leitores/9").then((response) => {
      this.leitores = response.data;
    });
        this.nomeEstagio = "Em Manutenção";
    },
    manutencaoConcluida() {
         axios.get("http://localhost:5000/leitores/11").then((response) => {
      this.leitores = response.data;
    });
        this.nomeEstagio = "Manutenção Concluida";
    },
    reprovado() {
         axios.get("http://localhost:5000/leitores/17").then((response) => {
      this.leitores = response.data;
    });
        this.nomeEstagio = "Reprovado :(";
    },
    finalizado() {
         axios.get("http://localhost:5000/leitores/15").then((response) => {
      this.leitores = response.data;
    });
